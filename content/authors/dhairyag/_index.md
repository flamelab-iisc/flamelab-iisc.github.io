...
- icon: envelope
  icon_pack: fas
  link: 'mailto:dhairyagarg@iisc.ac.in'  # For a direct email link, use "mailto:test@example.org".
# - icon: twitter
#  icon_pack: fab
...
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/dhairya-garg-731a84298
...
---
I work on combustion related problems. My extracurricular interests involve playing chess, table tennis and cricket.

...
<table style="width: 130%; margin-left: -15%; border-collapse: collapse; font-size: 1.1rem; margin-top: 1rem;">
  ...
  <tbody>
      ...
      <td style="padding: 10px; text-align: center;">
        <span style="display: inline-block; width: 110px; height: 110px; border-radius: 50%; overflow: hidden;">
          <img src="./intern_photos/ominamdar.jpeg"
               style="width: 100%; height: 100%; object-fit: cover; transform: scale(1.5) translateX(0px) translateY(0px);">
        </span>
      </td>
    ...
    <tr>
      <td style="padding: 10px; text-align: center;">
        <span style="display: inline-block; width: 110px; height: 110px; border-radius: 50%; overflow: hidden;">
          <img src="./intern_photos/kushagreekbasu.PNG"
               style="width: 100%; height: 100%; object-fit: cover; transform: scale(3.0) translateX(10px) translateY(10px);">
        </span>
      </td>
    ...
    <tr>
      <td style="padding: 10px; text-align: center;">
        <span style="display: inline-block; width: 110px; height: 110px; border-radius: 50%; overflow: hidden;">
          <img src="./intern_photos/abhinavthangarajusethupathy.jpeg"
               style="width: 100%; height: 130%; object-fit: cover; transform: scale(2.0) translateY(10px);">
        </span>
      </td>
    ...
    <tr>
      <td style="padding: 10px; text-align: center;">
        <span style="display: inline-block; width: 110px; height: 110px; border-radius: 50%; overflow: hidden;">
          <img src="./intern_photos/shashankpai.jpeg"
               style="width: 100%; height: 130%; object-fit: cover; transform: scale(3.0) translateY(-10px) translateX(2px);">
        </span>
      </td>
    ...
    <tr>
      <td style="padding: 10px; text-align: center;">
        <span style="display: inline-block; width: 110px; height: 110px; border-radius: 50%; overflow: hidden;">
          <img src="./intern_photos/aldisdaniel.png"
               style="width: 100%; height: 130%; object-fit: cover; transform: scale(2.0) translateY(-20px) translateX(-25px);">
        </span>
      </td>
    ...
    <tr>
      <td style="padding: 10px; text-align: center;">
        <span style="display: inline-block; width: 110px; height: 110px; border-radius: 50%; overflow: hidden;">
          <img src="./intern_photos/yashdewangan.jpeg"
               style="width: 100%; height: 130%; object-fit: cover; transform: scale(2.5) translateY(25px) translateX(-2px);">
        </span>
      </td>
